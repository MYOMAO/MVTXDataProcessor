...
Initialdir=/sphenix/user/zshi/MVTXDecodedData/PixJobSub
...
#Output=/tmp
Output=/sphenix/user/zshi/MVTXDecodedData/PixJobSub/out/job.$(Cluster).out
...
Error=/sphenix/user/zshi/MVTXDecodedData/PixJobSub/err/job.$(Cluster).err
...
Log=/sphenix/user/zshi/MVTXDecodedData/PixJobSub/log/myjob.$(Cluster).log
