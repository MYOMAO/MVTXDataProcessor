...
#include "/sphenix/user/zshi/MVTXDecodedData/MVTXINTTEvtDisplay/PlotWorld/PlotWorld.h"
...
void UserAnalysisInit()
{
  Fun4AllServer* se = Fun4AllServer::instance();
	gSystem->Load("PlotWorld.so");


	PlotWorld * Test = new PlotWorld("PlotTest",Enable::DetectorType);
	Test->Verbosity(0);
