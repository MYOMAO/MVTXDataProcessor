...
Initialdir=/sphenix/user/zshi/MVTXDecodedData/ClusJobSub
...
#Output=/tmp
Output=/sphenix/user/zshi/MVTXDecodedData/ClusJobSub/out/job.$(Cluster).out
...
Error=/sphenix/user/zshi/MVTXDecodedData/ClusJobSub/err/job.$(Cluster).err
...
Log=/sphenix/user/zshi/MVTXDecodedData/ClusJobSub/log/myjob.$(Cluster).log
