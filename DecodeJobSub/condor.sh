...
Initialdir=/sphenix/user/zshi/MVTXDecodedData/JobSub
...
#Output=/tmp
Output=/sphenix/user/zshi/MVTXDecodedData/JobSub/out/job.$(Cluster).out
...
Error=/sphenix/user/zshi/MVTXDecodedData/JobSub/err/job.$(Cluster).err
...
Log=/sphenix/user/zshi/MVTXDecodedData/JobSub/log/myjob.$(Cluster).log
